...
WWW::Shopify::Model::DBIx::Schema::Result::Model::DBIx::Schema::Result::Model::MetafieldVariant - Database Object for WWW::Shopify::Model::DBIx::Schema::Result::Model::MetafieldVariant.
...
use warnings;
			...
			__PACKAGE__->table('shopify_metafieldvariant');
