...
WWW::Shopify::Model::DBIx::Schema::Result::Model::Order::PaymentDetails - Database Object for WWW::Shopify::Model::Order::PaymentDetails.
...
use warnings;
		...
		__PACKAGE__->table('shopify_orderpayment_details');	
		__PACKAGE__->add_columns('credit_card_company', { data_type => 'varchar(255)', is_nullable => 1 },
