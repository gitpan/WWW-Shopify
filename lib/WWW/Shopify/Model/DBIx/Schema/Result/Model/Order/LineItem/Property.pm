...
WWW::Shopify::Model::DBIx::Schema::Result::Model::Order::LineItem::Property - Database Object for WWW::Shopify::Model::Order::LineItem::Property.
...
use warnings;
		...
		__PACKAGE__->table('shopify_properties');	
