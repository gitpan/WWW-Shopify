...
WWW::Shopify::Model::DBIx::Schema::Result::Model::Transaction::Receipt - Database Object for WWW::Shopify::Model::Transaction::Receipt.
...
use warnings;
		...
		__PACKAGE__->table('shopify_transactionreceipts');	
		...
		__PACKAGE__->belongs_to(transaction => 'WWW::Shopify::Model::DBIx::Schema::Result::Model::Transaction', 'parent_id');
