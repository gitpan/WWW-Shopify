...
WWW::Shopify::Model::DBIx::Schema::Result::Model::DBIx::Schema::Result::Model::CustomerMetafield - Database Object for WWW::Shopify::Model::DBIx::Schema::Result::Model::CustomerMetafield.
...
use warnings;
			...
			__PACKAGE__->table('shopify_customermetafield');
