...
WWW::Shopify::Model::DBIx::Schema::Result::Model::DBIx::Schema::Result::Model::CustomCollectionMetafield - Database Object for WWW::Shopify::Model::DBIx::Schema::Result::Model::CustomCollectionMetafield.
...
use warnings;
			...
			__PACKAGE__->table('shopify_customcollectionmetafield');
