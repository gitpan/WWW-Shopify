...
WWW::Shopify::Model::DBIx::Schema::Result::Model::Product::Option - Database Object for WWW::Shopify::Model::Product::Option.
...
use warnings;
		...
		__PACKAGE__->table('shopify_productoptions');	
		__PACKAGE__->add_columns('name', { data_type => 'varchar(255)', is_nullable => 1 },
			'shop_id', { data_type => 'int', is_nullable => 1 },
			'id', { data_type => 'int', is_auto_increment => 1 },
			'parent_id', { data_type => 'int', is_nullable => 0 });
		__PACKAGE__->belongs_to(shop => 'WWW::Shopify::Model::DBIx::Schema::Result::Model::Shop', 'shop_id');
		__PACKAGE__->set_primary_key('id');
		__PACKAGE__->belongs_to(product => 'WWW::Shopify::Model::DBIx::Schema::Result::Model::Product', 'parent_id');
