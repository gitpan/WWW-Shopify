...
WWW::Shopify::Model::DBIx::Schema::Result::Model::Order::Fulfillment::Receipt - Database Object for WWW::Shopify::Model::Order::Fulfillment::Receipt.
...
use warnings;
		...
		__PACKAGE__->table('shopify_fulfillmentreceipts');	
		__PACKAGE__->add_columns('testcase', { data_type => 'bool', is_nullable => 1 },
		...
		__PACKAGE__->belongs_to(fulfillment => 'WWW::Shopify::Model::DBIx::Schema::Result::Model::Order::Fulfillment', 'parent_id');
