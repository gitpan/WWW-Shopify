...
WWW::Shopify::Model::DBIx::Schema::Result::Model::Address - Database Object for WWW::Shopify::Model::Address.
...
use warnings;
		...
		__PACKAGE__->add_columns('country', { data_type => 'varchar(255)', is_nullable => 1 },
