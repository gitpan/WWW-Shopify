...
WWW::Shopify::Model::DBIx::Schema::Result::Model::Order::NoteAttributes - Database Object for WWW::Shopify::Model::Order::NoteAttributes.
...
use warnings;
		...
		__PACKAGE__->table('shopify_ordernote_attributes');	
		__PACKAGE__->add_columns('value', { data_type => 'varchar(255)', is_nullable => 1 },
