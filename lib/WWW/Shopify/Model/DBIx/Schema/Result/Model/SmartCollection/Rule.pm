...
WWW::Shopify::Model::DBIx::Schema::Result::Model::SmartCollection::Rule - Database Object for WWW::Shopify::Model::SmartCollection::Rule.
...
use warnings;
		...
		__PACKAGE__->table('shopify_smart_collectionrules');	
		__PACKAGE__->add_columns('relation', { data_type => 'varchar(255)', is_nullable => 1 },
