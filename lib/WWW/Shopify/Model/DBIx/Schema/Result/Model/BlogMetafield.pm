...
WWW::Shopify::Model::DBIx::Schema::Result::Model::DBIx::Schema::Result::Model::BlogMetafield - Database Object for WWW::Shopify::Model::DBIx::Schema::Result::Model::BlogMetafield.
...
use warnings;
			...
			__PACKAGE__->table('shopify_blogmetafield');
