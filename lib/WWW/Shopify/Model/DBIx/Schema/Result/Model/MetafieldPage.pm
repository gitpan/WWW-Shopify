...
WWW::Shopify::Model::DBIx::Schema::Result::Model::DBIx::Schema::Result::Model::MetafieldPage - Database Object for WWW::Shopify::Model::DBIx::Schema::Result::Model::MetafieldPage.
...
use warnings;
			...
			__PACKAGE__->table('shopify_metafieldpage');
