...
__PACKAGE__->add_columns(
	...
	"customer_email", { is_nullable => '1', data_type => 'VARCHAR(255)' },
	...
	"plan_name", { data_type => 'TEXT', is_nullable => '1' },
...
__PACKAGE__->has_many(users => 'WWW::Shopify::Model::DBIx::Schema::Result::Model::User', 'shop_id');
